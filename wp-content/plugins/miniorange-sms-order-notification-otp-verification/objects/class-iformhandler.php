...
interface IFormHandler {
	...
	/**MoInternal Function to get phone html tag.
	 *
	 * @return mixed
	 */
	public function get_phone_html_tag();

	/**MoInternal Function to get email html tag.
	 *
	 * @return mixed
	 */
	public function get_email_html_tag();

	/**MoInternal Function to get phone and email html tag.
	 *
	 * @return mixed
	 */
	public function get_both_html_tag();

	/**MoInternal Function to get form key.
	 *
	 * @return mixed
	 */
	public function get_form_key();

	/**MoInternal Function to get form name.
	 *
	 * @return mixed
	 */
	public function get_form_name();

	/**MoInternal Function to check which otp type is enabled.
	 *
	 * @return mixed
	 */
	public function get_otp_type_enabled();

	/**MoInternal Function to disabled auto activation.
	 *
	 * @return mixed
	 */
	public function disable_auto_activation();

	/**MoInternal Function to get phone key details.
	 *
	 * @return mixed
	 */
	public function get_phone_key_details();

	/**MoInternal Function to check if form is enabled.
	 *
	 * @return mixed
	 */
	public function is_form_enabled();

	/**MoInternal Function to get email key details.
	 *
	 * @return mixed
	 */
	public function get_email_key_details();

	/**MoInternal Function to get button texts.
	 *
	 * @return mixed
	 */
	public function get_button_text();

	/**MoInternal Function to get form details.
	 *
	 * @return mixed
	 */
	public function get_form_details();

	/**MoInternal Function to get verification type.
	 *
	 * @return mixed
	 */
	public function get_verification_type();

	/**MoInternal Function to get form documents.
	 *
	 * @return mixed
	 */

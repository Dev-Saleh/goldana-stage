...
if ( ! class_exists( 'VerificationLogic' ) ) {
	...
	abstract class VerificationLogic {
		 ...
		 */
		abstract public function mowc_handle_logic( $user_login, $user_email, $phone_number, $otp_type, $from_both );
		 ...
		 */
		abstract public function mowc_handle_otp_sent( $user_login, $user_email, $phone_number, $otp_type, $from_both, $content );
		 ...
		 * @param array  $content       string the json decoded response from server.
		 */
		abstract public function mowc_handle_otp_sent_failed( $user_login, $user_email, $phone_number, $otp_type, $from_both, $content );
		 ...
		 */
		abstract public function mowc_get_otp_sent_message();
		 ...
		 * show that to the user instead of the default one.
		 */
		abstract public function mowc_get_otp_sent_failed_message();
		 ...
		 * default one.
		 */
		abstract public function mowc_get_otp_invalid_format_message();
		 ...
		 */
		abstract public function mowc_get_is_blocked_message();
		 ...
		 */
		abstract public function mowc_handle_matched( $user_login, $user_email, $phone_number, $otp_type, $from_both );
		 ...
		 * @param string $from_both     has user enabled from both.
		 */
		abstract public function mowc_handle_not_matched( $phone_number, $otp_type, $from_both );
		 ...
		 * @param string $from_both     string has user enabled from both.
		 */
		abstract public function mowc_start_otp_verification( $user_login, $user_email, $phone_number, $otp_type, $from_both );
		 ...
		 * @return bool
		 */
		abstract public function mowc_is_blocked( $user_email, $phone_number );
		...
		public static function is_ajax_form() {
			return (bool) apply_filters( 'mowc_is_ajax_form', false );
		}
	}
}
